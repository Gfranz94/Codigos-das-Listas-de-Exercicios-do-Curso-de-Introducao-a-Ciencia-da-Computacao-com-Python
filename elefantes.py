...
#Este exercício tem duas partes:
    ...
    #"incomodam " (a palavra seguida de um espaço) n vezes.
    #Se n não for um inteiro estritamente positivo,
    #a função deve devolver uma string vazia.
...
#singular ("Um elefante..."); para os demais, utilize números e o
#plural ("2 elefantes...").
#Dica: lembre-se que é possível juntar strings com o operador "+".
#Lembre-se também que é possível transformar números em strings com a
#função str().
